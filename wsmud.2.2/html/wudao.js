...
//         // console.log(wsmud.data.wudaodata);
//     }
...
//             // console.log(data[typeEN]);
//             u.list[typeEN] = wsmud.data.wudaodata()[typeEN];
//             // console.log(u.list[typeEN].length);
//         }
//         for (var i = 0; i < 3; i++) {
//             var wudao = u.list[typeEN][i];
//             if (u.list[typeEN][i] == undefined) break;
//             $("#buttons").append(
...
//                     // getText
//                     skill.upLogs.forEach(wudao => {
//                         if (r == "") r = wudao.getText(skill.level, skill.k - 1);
//                         else r += "<br>" + wudao.getText(skill.level, skill.k - 1);
//                     });
//                     return r;
//                 })()),
//             )
